...
import lab1.classicalciphers.implementations.CaesarCipher
import lab1.classicalciphers.implementations.CaesarPermutationCipher
import lab1.classicalciphers.implementations.PlayfairCipher
import lab1.classicalciphers.implementations.VigenereCipher
...
fun main() {
    ...
    println(
        "Caesar Cipher (K=$caesarKey) encrypted '$plaintext' to '$ciphertextCaesar'. \n" +
                "Caesar Cipher decrypted '$ciphertextCaesar' to '${
    ...
    println(
        "Caesar Permutation Cipher (K=$caesarKey, SEED=$seed) encrypted '$plaintext' to '$ciphertextCaesarPerm'. \n" +
                "Caesar Permutation Cipher decrypted '$ciphertextCaesarPerm' to '${
                    caesarPermutationCipher.decrypt(
                        ciphertextCaesar,
                        caesarKey
                    )
                }'. "
    ...
    println(
        "Vigenere Cipher (K=$vigenereKey) encrypted '$plaintext2' to '$ciphertextVigenere'. \n" +
                "Vigenere Cipher decrypted '$ciphertextVigenere' to '${
    ...
    println(
        "Playfair Cipher (K=$playfairKey) encrypted '$plaintext3' to '$ciphertextPlayfair'. \n" +
                "Playfair Cipher decrypted '$ciphertextPlayfair' to '${
